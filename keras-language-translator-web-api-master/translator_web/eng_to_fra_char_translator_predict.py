...
class EngToFraCharTranslator(object):
    ...
    def __init__(self):
        self.input_char2idx = np.load('C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra/eng-to-fra-char-input-char2idx.npy').item()
        self.input_idx2char = np.load('C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra/eng-to-fra-char-input-idx2char.npy').item()
        self.target_char2idx = np.load('C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra/eng-to-fra-char-target-char2idx.npy').item()
        self.target_idx2char = np.load('C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra/eng-to-fra-char-target-idx2char.npy').item()
        context = np.load('C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra/eng-to-fra-char-context.npy').item()
        ...
        self.model.load_weights('C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra/eng-to-fra-char-weights.h5')
