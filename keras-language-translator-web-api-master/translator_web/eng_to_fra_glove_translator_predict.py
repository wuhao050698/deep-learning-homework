...
MODEL_DIR_PATH = 'C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/models/eng-to-fra'
VERY_LARGE_DATA_DIR_PATH = 'C:/Users/wu/Desktop/keras-language-translator-web-api-master/translator_train/very_large_data'
...
class EngToFraGloveTranslator(object):
    model = None
    encoder_model = None
    decoder_model = None
    ...
    def translate_lang(self, input_text):
        ...
        for word in nltk.word_tokenize(input_text.lower()):
            idx = self.unknown_emb
            if word in self.word2em:
                idx = self.word2em[word]
